...
class Settings(BaseSettings):
    ...
    MAXIMUM_TOKEN_FOR_SUMMARIZATION: int = os.environ.get(
        "MAXIMUM_TOKEN_FOR_SUMMARIZATION", 2000
    )
    MAX_SUMMARY_TOKENS: int = os.environ.get("MAX_SUMMARY_TOKENS", 4000)
    ...
    FILE_TYPE: list[str] = os.environ.get(
